...
{
    return GetBoolArg("-testnet", false) ? 26826 : 16826;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop DiceCoin server (and possibly override the detachdb config value).");
